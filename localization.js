(function () {
  ...
  const EN = {
    ...
    '中風上肢復康訓練':'Stroke Upper-limb Rehabilitation Training',
    '港式神功修煉':'Hong Kong Kung Fu Training',
    '欲要成功，必先勤功！':'Success comes from diligent practice!',
    '選擇 Level':'Choose a level',
    '請選擇 Level 開始修煉':'Choose a level to begin training',
    '請選擇 Level':'Choose a level',
    '膊頭屈曲 30–60°':'Shoulder flexion 30–60°',
    '膊頭屈曲 60° 或以上':'Shoulder flexion 60° or above',
    '拿杯 (active shoulder flexion)':'Hold a cup (active shoulder flexion)',
    '雙手舉棒 (active-assisted shoulder flexion)':'Lift the bar with both hands (active-assisted shoulder flexion)',
    '佛光初現':'First Light of the Buddha',
    '初現曙光，神功開竅':'The first glimmer: the skill awakens',
    '大鵬展翅':'The Great Roc Spreads Its Wings',
    '舉高膊頭，生龍活虎':'Raise the shoulder, full of vigour',
    '如來神掌':'Palm of the Buddha',
    ...
    '任務':'Task',
    '患臂肩屈曲功能任務':'Affected-arm shoulder-flexion functional tasks',
    '患臂主動抬高手臂，把物件運送到功能目標':'Actively raise the affected arm and transport the object to the functional target.',
    '患手三點捏握功能任務':'Affected-hand tripod-pinch tasks',
    '患手三指張開、輕捏拿起、移動，再張開放下':'Open the affected thumb, index and middle fingers; lightly pinch to pick up, move, then reopen to release.',
    '三指張開 → 輕捏拿起 → 移動 → 張開放下':'Open three fingers → light pinch to pick up → move → reopen to release',
    '患手三指張開，輕捏拿起花材，移到花瓶，再張開放下':'Open the affected three fingers, lightly pinch to pick up a flower, move it to the vase, then reopen to release.',
    '患手三指張開，輕捏拿起點心，移到飯碗，再張開放下':'Open the affected three fingers, lightly pinch to pick up dim sum, move it to the rice bowl, then reopen to release.',
    '患手三指張開，輕捏拿起衣物，移到晾衫繩，再張開放下':'Open the affected three fingers, lightly pinch to pick up the garment, move it to the drying line, then reopen to release.',
    '患手三指張開，輕捏拿起啤牌，移到相同花色，再張開放下':'Open the affected three fingers, lightly pinch to pick up the card, move it to the matching suit, then reopen to release.',
    '患手三指張開，輕捏拿起麻雀，移到相同圖案，再張開放下':'Open the affected three fingers, lightly pinch to pick up the mahjong tile, move it to the matching pattern, then reopen to release.',
    '患手三指張開，輕捏拿起食材，移到目標，再張開放下':'Open the affected three fingers, lightly pinch to pick up the ingredient, move it to the target, then reopen to release.',
    '患手三指張開、輕捏拿起；移到飯碗，再張開放下':'Open the affected three fingers and lightly pinch to pick up; move to the rice bowl, then reopen to release.',
    '患手三指張開、輕捏拿起；移到晾衫繩，再張開放下':'Open the affected three fingers and lightly pinch to pick up; move to the drying line, then reopen to release.',
    '患手三指輕捏拿起點心，移到飯碗，再張開放下':'Lightly tripod-pinch with the affected hand to pick up dim sum, move it to the rice bowl, then reopen to release.',
    '患手三指輕捏拿起衣物，移到晾衫繩，再張開放下':'Lightly tripod-pinch with the affected hand to pick up the garment, move it to the drying line, then reopen to release.',
    '三指張開 → 輕捏拿起 → 移動 → 張開放下；只偵測已選患手':'Open three fingers → light pinch to pick up → move → reopen to release; selected affected hand only.',
    '筷子點心':'Chopstick Dim Sum',
    '衣夾晾衫':'Cloth-Peg Laundry',
    '插花':'Flower Arranging',
    '啤牌':'Playing Cards',
    '麻雀':'Mahjong',
    '煮蛋炒飯':'Cook Egg Fried Rice',
    '主動抬高手臂，把虛擬花材運送到花瓶':'Actively raise the arm and transport the virtual flowers to the vase.',
    '主動抬高手臂運送 → 把花材放入花瓶':'Actively raise the arm to transport → place the flowers in the vase',
    '主動抬高手臂，把虛擬啤牌運送到相同花色的牌堆':'Actively raise the arm and transport the virtual card to the matching suit pile.',
    '主動抬高手臂運送 → 把啤牌放到相同花色':'Actively raise the arm to transport → match the playing-card suit',
    '主動抬高手臂，把虛擬麻雀運送到相同圖案的位置':'Actively raise the arm and transport the virtual mahjong tile to the matching pattern.',
    '主動抬高手臂運送 → 把麻雀放到相同圖案':'Actively raise the arm to transport → match the mahjong pattern',
    '主動抬高手臂運送，依照步驟完成虛擬蛋炒飯':'Actively raise the arm to transport and follow the steps to complete the virtual egg fried rice.',
    '主動抬高手臂運送 → 依照步驟煮蛋炒飯':'Actively raise the arm to transport → follow the egg-fried-rice steps',
    '手持真實筷子（三指輕捏），肩屈曲到目標，虛擬筷子夾起點心，放入飯碗':'Hold real chopsticks with a three-finger pinch; flex the shoulder to the target and the virtual chopsticks pick up dim sum and place it in the rice bowl.',
    '手持筷子 → 主動肩屈曲到目標 → 移到飯碗':'Hold the chopsticks → actively flex the shoulder to the target → move to the rice bowl',
    '手持真實膠衣夾（三指輕捏），肩屈曲到目標，虛擬衣夾夾起衣物，晾上晾衫繩':'Hold a real plastic cloth peg with a three-finger pinch; flex the shoulder to the target and the virtual peg clips the garment onto the drying line.',
    '手持衣夾 → 主動肩屈曲到目標 → 移到晾衫繩':'Hold the cloth peg → actively flex the shoulder to the target → move to the drying line',
    '手持真實筷子（三指輕捏），肩屈曲到目標，虛擬筷子將點心放入飯碗':'Hold real chopsticks with a three-finger pinch; flex the shoulder to the target and the virtual chopsticks place dim sum in the rice bowl.',
    '手持真實膠衣夾（三指輕捏），肩屈曲到目標，虛擬衣夾將衣物晾上晾衫繩':'Hold a real plastic cloth peg with a three-finger pinch; flex the shoulder to the target and the virtual peg hangs the garment on the drying line.',
    '肩屈曲運送':'Shoulder-flexion transport',
    '蝦餃點心，代表筷子點心任務':'Har gao dim sum, representing the Chopstick Dim Sum task',
    '上衣待晾，代表衣夾晾衫任務':'A shirt awaiting hanging, representing the Cloth-Peg Laundry task',
    '手持筷子，主動抬高手臂把點心運送到飯碗':'Hold the chopsticks and actively raise the arm to transport the dim sum to the rice bowl.',
    '手持衣夾，主動抬高手臂把衣物運送到晾衫繩':'Hold the cloth peg and actively raise the arm to transport the garment to the drying line.',
    '手持筷子，主動肩屈曲至治療師選定的目標':'Hold the chopsticks and actively flex the shoulder to the therapist-selected target.',
    '手持筷子（三指輕捏）→主動肩屈曲到目標→移到飯碗；不識別真實筷子，不偵測抓放':'Hold chopsticks (three-finger pinch) → actively flex the shoulder to the target → move to the rice bowl; the site does not identify the real chopsticks or detect grasp/release.',
    '手持衣夾，主動肩屈曲至治療師選定的目標':'Hold the cloth peg and actively flex the shoulder to the therapist-selected target.',
    '手持衣夾（三指輕捏）→主動肩屈曲到目標→移到晾衫繩；不識別真實衣夾，不偵測開合':'Hold the cloth peg (three-finger pinch) → actively flex the shoulder to the target → move to the drying line; the site does not identify the real peg or detect opening/closing.',
    '筷子點心偵測患手食指＋中指開合；衣夾晾衫偵測患手三點捏握開合；肩屈曲控制運送':'Chopstick Dim Sum detects opening and closing of the affected index and middle fingers; Cloth-Peg Laundry detects affected-hand tripod opening and closing; shoulder flexion controls transport.',
    '患手食指及中指稍伸直打開筷子，稍屈曲夾起點心；肩屈曲運送，到飯碗再伸直放下':'Slightly extend the affected index and middle fingers to open the chopsticks, then slightly flex them to pick up dim sum; use shoulder flexion to transport it, then extend the fingers to release it into the rice bowl.',
    '兩個工具任務只偵測已選患手的指定手指開合；肩屈曲控制運送。網頁不識別實體工具，亦不量度握力或捏力；由治療師全程監督。':'The two tool tasks detect only the specified opening and closing gesture of the selected affected hand; shoulder flexion controls transport. The site does not identify physical tools or measure grip or pinch force; therapist supervision is required throughout.',
    '可選插花、筷子點心、衣夾晾衫、啤牌、麻雀或煮蛋炒飯。筷子點心偵測已選患手食指＋中指開合；衣夾晾衫偵測已選患手三點捏握開合；肩屈曲控制運送。網頁不識別實體工具，亦不量度握力或捏力。':'Choose Flower Arranging, Chopstick Dim Sum, Cloth-Peg Laundry, Playing Cards, Mahjong, or Cook Egg Fried Rice. Chopstick Dim Sum detects opening and closing of the selected affected index and middle fingers; Cloth-Peg Laundry detects selected affected-hand tripod opening and closing; shoulder flexion controls transport. The site does not identify physical tools or measure grip or pinch force.',
    '患手食指及中指伸直打開、屈曲夾起；肩屈曲運送，到飯碗再伸直放下':'Extend the affected index and middle fingers to open, flex them to pick up, use shoulder flexion to transport, then extend again to release into the rice bowl.',
    '食指＋中指稍伸直打開 → 稍屈曲夾起 → 肩屈曲運送 → 再伸直放下；只偵測已選患手':'Slightly extend index + middle fingers to open → slightly flex to pick up → shoulder flexion to transport → extend again to release; selected affected hand only.',
    '患手三點捏握張開衣夾、輕捏夾起；肩屈曲運送，到晾衫繩再張開放下':'Use an affected-hand tripod grasp to open the peg, lightly close to pick up, use shoulder flexion to transport, then open again to release at the drying line.',
    '三點捏握張開 → 輕捏夾起 → 肩屈曲運送 → 再張開放下；只偵測已選患手':'Open with a tripod grasp → lightly close to pick up → shoulder flexion to transport → open again to release; selected affected hand only.',
    '開始前確認（FTHUE Level 6）':'Pre-session check (FTHUE Level 6)',
    '坐穩；患臂離桌，主動抬高手臂完成運送。':'Sit steady; keep the affected arm off the table and actively raise it to complete the transport.',
    '先選擇功能活動；筷子點心或衣夾晾衫才使用真實工具。':'Choose a functional activity first; only Chopstick Dim Sum and Cloth-Peg Laundry use a real tool.',
    '治療師全程監督；如使用實體工具，確認拿法正確。':'The therapist supervises throughout and confirms correct handling when a physical tool is used.',
    '選擇功能活動 → 主動抬高手臂運送 → 完成任務':'Choose a functional activity → actively raise the arm to transport → complete the task',
    '患臂手持真實衣夾，主動抬高手臂把衣物運送到晾衫繩':'The affected arm holds a real cloth peg and raises to transport the garment to the drying line.',
    '患臂手持真實筷子，主動抬高手臂把點心運送到飯碗':'The affected arm holds real chopsticks and raises to transport the dim sum to the rice bowl.',
    '坐在椅子或輪椅，患臂離開桌面':'Sit in a chair or wheelchair with the affected arm off the table.',
    '選好功能活動後即可開始，不需選擇肩屈曲角度':'Choose a functional activity and begin without selecting a shoulder-flexion angle.',
    '六個功能活動：插花／筷子點心／衣夾晾衫／啤牌／麻雀／煮蛋炒飯':'Six functional activities: Flower Arranging, Chopstick Dim Sum, Cloth-Peg Laundry, Playing Cards, Mahjong, and Cook Egg Fried Rice.',
    '筷子點心／衣夾晾衫使用真實工具；其餘為虛擬活動':'Chopstick Dim Sum and Cloth-Peg Laundry use real tools; the other activities are virtual.',
    '玩法':'Interaction mode',
    ...
    '荃灣保齡球場':'Tsuen Wan Bowling Alley',
    '點心遊戲顯示模式':'Dim sum display mode',
    '模擬茶樓':'Simulated teahouse',
    '看到自己':'See yourself',
    '抬高患側上肢到目標角度，保齡球就會滾上球道，撞冧全部樽':'Lift the affected arm to the target angle and the bowling ball rolls down the lane, knocking over all the pins',
    '球樽':'Pins',
    '肩前屈抬臂':'Shoulder-flexion arm lift',
    '懷舊荃灣保齡球場木球道同十個保齡球樽':'Retro Tsuen Wan bowling alley wooden lane with ten pins',
    '抹窗擦霧':'Window wiping',
    '保齡球':'Bowling ball',
    '巴士拍卡':'Bus card tap',
    '衣物分類':'Laundry sorting',
    '雪櫃收納':'Fridge storage',
    '將買返嚟嘅餸菜逐樣放入雪櫃':'Put the groceries into the fridge one by one',
    '雪櫃':'Fridge',
